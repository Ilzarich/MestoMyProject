...
import { createCardElement, handleDeleteCard, handleLikeIcon } from './card';
import { openModalWindow, closeModalWindow, setCloseModalWindowEventListeners } from './modal';
...
const handlePreviewPicture = ({name, link}) => {
    ...
    imageElement.alr = `Изображение ${name}`;
